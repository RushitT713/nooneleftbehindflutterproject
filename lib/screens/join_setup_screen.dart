          ...
          child: Column(
            ...
            children: [
                          ...
                          ClipRRect(
                            ...
                            child: Image.asset(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                return const Icon(Icons.person, size: 80, color: kTextTertiary);
                              },
                            ),
                          ),
              ...
              Text(
                  ...
                  style: theme.textTheme.labelLarge?.copyWith(fontSize: 14, color: kTextTertiary)
              ),
              const SizedBox(height: 8),
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: const UnderlineInputBorder(
                    borderSide: BorderSide(color: kSurfaceBorder, width: 2),
                  ),
              ...
              Row(
                ...
                children: [
                  IconButton(
                    icon: const Icon(Icons.arrow_back_ios, size: 40, color: kTextSecondary),
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          ...
                          height: 130,
                          errorBuilder: (context, error, stackTrace) {
                            return const Icon(Icons.directions_car, size: 130, color: kTextSecondary);
                          },
                        ),
                  ...
                  IconButton(
                    icon: const Icon(Icons.arrow_forward_ios, size: 40, color: kTextSecondary),
